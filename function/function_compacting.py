...
class Compaction:
    def __init__(self, init_function):
        assert isinstance(init_function, parentFunction), f'excpected type "parentFunction", got {type(init_function)}'
    ...
    def join_add_elements(self):
        ...
        for i,obj1 in enumerate(new_init_structure):
            for obj2 in self.init_structure[i:]:
                if check_if_equal_function(obj1, obj2):
...
def check_if_equal_function(func1, func2):
    if isinstance(func1, parentFunction) == isinstance(func2, parentFunction) == True:
        ...
        print(func1.__class__.__name__)
        if (func1.__class__.__name__ == func2.__class__.__name__) and (func1.init_structure == func2.init_structure):
            return True
